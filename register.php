...
$username = $email = $password = $name =$age=$gender=$ifallergy=$healthissues=$height=$weight =$skintype="";
        ...
        <div class="form-wrap border rounded p-4">
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <div class="mb-3">
              ...
              <!-- <input type="number" class="form-control" name="age" id="age" value="<?= $age; ?>"> -->
              <select id="cars" name="cars" value="<?= $gender; ?>">
            ...
            <div class="mb-3">
              <label for="allergy" class="form-label">Allergic or not ? If yes mention</label>
              <input type="text" class="form-control" name="allergy" id="allergy" value="<?= $ifallergy; ?>">
</div>
<div class="mb-3">
              <label for="hissue" class="form-label">Mention any current/previous Health issue</label>
              <input type="text" class="form-control" name="hissue" id="hissue" value="<?= $healthissues; ?>">
</div>
...
<div class="mb-3">
            ...
            <div class="mb-3">
              <label for="skintype" class="form-label">Enter Your Skin Type</label>
              <input type="text" class="form-control" name="skintype" id="skintype" value="<?= $skintype; ?>">
</div>
